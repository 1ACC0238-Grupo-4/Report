...
NRC: 12617
<br>
<strong>Docente: Jorge Luis Mayta Guillermo</strong> </p>
...
<div align="center">
<p align="=center">
Rodigo Liberato Saldana - U202215623  <br>  
Berrocal Ramirez Omar - U20201B529  <br> 
Diestra Zambrano Adriana Maria - U202218110 </p>
...
| 3.0     | 02/12/2025 | Rodigro Liberato                | Correccion de las entrevistas de validación                                 |
| 3.1     | 04/12/2025 | ROdigro Liberato                | Se agregó evidencias del desarrollo, ejecución y documentaicón de servicios |
| 3.2     | 04/12/2025 | Adriana Diestra                 | Se agregó Sprint planning para el sprint 3                                  |
| 3.3     | 05/12/2025 | Omar Berrocal                   | Se agregó el testing suite para el sprint 3                                 |
| 4.0     | 05/12/2025 | Omar Berrocal                   | Versión final del informe entregable del trabajo final                      |
...
El Sprint Planning 3 tuvo como objetivo asegurar la continuidad del trabajo en este entregable. Durante este sprint se lograron los objetivos planteados. Estas tareas permitieron consolidar el progreso del proyecto y fortalecer su presentación visual y funcional.
...
| **Prepared By**                        | Adriana Diestra                                                                                                                                                                                                                                                                                                                                 |
| **Attendees (to planning meeting)**    | Rodrigo Liberato, Omar Berrocal, Moises Espinoza, Adriana Diestra                                                                                                                                                                                                                                                                               |
| **Sprint n - 2 Review Summary**        | En el sprint anterior se culminó la aplicación Android, se optimizó la landing page y se avanzó en el desarrollo de la aplicación en Flutter. Estos avances consolidaron la presentación visual y funcional del proyecto, permitiendo iniciar este nuevo sprint con una base más sólida.                                                        |
| **Sprint n - 2 Retrospective Summary** | El equipo mantuvo una comunicación efectiva y logró cumplir los objetivos en los tiempos establecidos. La planificación clara permitió un desarrollo fluido y la entrega de funcionalidades consistentes.                                                                                                                                       |
| **Sprint 3 Goal**                      | Integrar la aplicación Android con el backend para habilitar funciones esenciales como el login, registro de usuarios y el sistema de reservas. Además, se buscó implementar la lógica para la creación de contratos y la visualización de detalles mediante llamadas al backend.                                                               |
| **Sprint 3 Development Summary**       | Se implementó la conexión con el backend para las funcionalidades de login y register. También se añadió el módulo de reservas, incluyendo la creación de contratos y la visualización de su detalle. Para ello se desarrollaron las páginas `contract_page` y `contract_details_page`, consumiendo los endpoints correspondientes del backend. |
| **Sprint 3 Velocity**                  | El equipo puede aceptar hasta 10 Story Points.                                                                                                                                                                                                                                                                                                  |
| **Sum of Story Points**                | La suma de Story Points atendidos es de 10.                                                                                                                                                                                                                                                                                                     |
...
| US-27 | Chat directo entre propietario y cliente | T33 | Implementación de `ChatScreen`            | Como propietario quiero contactarme directamente con el usuario interesado para tener la certeza de que se concrete el acuerdo                                | 3                | Omar Berrocal    | Done   |
| US-40 | Mensaje entre usuarios                   | T34 | Implementación de `ChatScreen`            | Como usuario quiero enviar y recibir mensajes para poder comunicarme con el propietario o el freelancer relacionado a una oficina.                            | 2                | Omar Berrocal    | Done   |
...
URL: [https://youtu.be/0pF87XxPrjI](https://youtu.be/0pF87XxPrjI)

### Video About the team

URL [https://youtu.be/W9AEN-tCxtE](https://youtu.be/W9AEN-tCxtE)
